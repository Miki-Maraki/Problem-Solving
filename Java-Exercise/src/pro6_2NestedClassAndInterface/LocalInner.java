...
public class LocalInner {
	...
	void display() { // method of the outer class	..............// start of method 
...
*/	   class Local { // local inner class  inside a method .... it cannot be invoked from outside the method.
			void msg() { // method of the inner local inner class inside the outer method
...
/*    // other Exmple
	class OuterClass {
		...
		public class Local {        // local inner class inside a method 
				void msg() {
