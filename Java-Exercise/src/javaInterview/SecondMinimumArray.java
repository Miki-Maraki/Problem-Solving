...
public class SecondMinimumArray {
	...
	public static void main(String [] args) {
		...
		System.out.println(arr[arr.length-2]); // 2nd minimum 21
		System.out.println(arr[arr.length-3]); // 3rd minimum 29
		System.out.println(arr[arr.length-4]); // 4th minimum 34
	}
